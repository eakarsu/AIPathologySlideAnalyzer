...
export default function GapMultiPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-multi/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Multi</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Multi-slide consensus — ensemble grading</p>
