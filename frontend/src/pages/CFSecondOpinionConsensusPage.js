...
// Custom Feature: Second opinion consensus
// Second opinion consensus: Route slide to multiple AI models simultaneously; display agreement/disagreement and explain differences
import React, { useState } from 'react';

export default function CFSecondOpinionConsensusPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-second-opinion-consensus/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Second opinion consensus</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Second opinion consensus: Route slide to multiple AI models simultaneously; display agreement/disagreement and explain differences</p>
