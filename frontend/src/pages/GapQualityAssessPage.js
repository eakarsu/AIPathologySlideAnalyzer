...
// Gap (AI): Quality assess
// Quality assess — flag image quality
import React, { useState } from 'react';

export default function GapQualityAssessPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-quality-assess/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Quality assess</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Quality assess — flag image quality</p>
