...
// Custom Feature: Educational mode
// Educational mode: Overlay AI annotations on slide; highlight areas of interest; allow pathologist to drill down and learn model reasoning
import React, { useState } from 'react';

export default function CFEducationalModePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-educational-mode/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Educational mode</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Educational mode: Overlay AI annotations on slide; highlight areas of interest; allow pathologist to drill down and learn model reasoning</p>
