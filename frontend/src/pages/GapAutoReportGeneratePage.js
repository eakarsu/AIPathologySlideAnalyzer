...
// Gap (AI): Auto report generate
// Auto report generate — structured pathology report
import React, { useState } from 'react';

export default function GapAutoReportGeneratePage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/gap-auto-report-generate/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Auto report generate</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Auto report generate — structured pathology report</p>
