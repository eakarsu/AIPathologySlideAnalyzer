...
// Custom Feature: Registry integration
// Registry integration: Auto-submit de-identified cases to cancer/tissue registries; contribute to research databases
import React, { useState } from 'react';

export default function CFRegistryIntegrationPage() {
  ...
  const run = async () => {
    ...
    try {
      ...
      const res = await fetch('/api/cf-registry-integration/run', {
        method: 'POST',
  ...
  return (
    <div style={{ padding: 24, color: '#e5e7eb' }}>
      <h1 style={{ fontSize: 24, fontWeight: 700, marginBottom: 8 }}>Registry integration</h1>
      <p style={{ color: '#9ca3af', marginBottom: 16 }}>Registry integration: Auto-submit de-identified cases to cancer/tissue registries; contribute to research databases</p>
